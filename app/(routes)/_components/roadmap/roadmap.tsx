...
const Roadmap = () => {
  return (
    <section className="relative mt-56 space-y-8">
      ...
      <div className="relative mx-auto flex h-80 w-[340px] flex-col rounded-2xl border-x border-t border-white/10 bg-gradient-to-b from-white/15 to-transparent pt-10 backdrop-blur-xl lg:w-fit lg:px-20">
        <div
          style={{
        ...
        <ScrollArea className="z-20 mx-auto h-96 pl-4 lg:pl-0" type="always">
